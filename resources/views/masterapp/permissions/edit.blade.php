        ...
        <div class="row justify-content-center">
            <div class="col-10">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('masterapp.permissions.update', $permission) }}" method="POST" id="form-edit-permission">
                        @csrf
                        @method('PUT')
                        @include('masterapp.permissions.form')
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <span id="btn-edit-text">Update Permissions</span>
